...
const cards = [
  {
    ...
    desc: "We design with your audience, goals, and growth in mind, creating work that connects and converts.",
  },
  {
    id: 2,
    icon: "/images/discovery-icon.svg",
        ...
        <div className="flex justify-between">
          <div>
            ...
            <p className="text-body-text">
              Every project we craft is driven by strategy, built for
              credibility, and optimized for performance.
            </p>
          </div>
        </div>
