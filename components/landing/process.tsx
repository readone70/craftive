...
const cards = [
  {
    ...
    desc: "We'll discuss your business, your ideal clients, and what success looks like for your website.",
  ...
  },
  {
    ...
    desc: "We create a website strategy focused on your goals, then design a site that reflects your brand and drives action.",
    cardBg: "bg-radial from-primary/30 to-primary-background",
  },
  {
    id: 3,
    tag: "3",
    price: "Development & Launch",
    desc: "We build your site with care, optimize for performance, and ensure everything works perfectly.",
    cardBg: "bg-pricing-card",
  },
];
