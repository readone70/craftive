    ...
    >
      <div className="flex flex-col items-center">
        ...
        <p className="text-center text-body-text w-full sm:w-[600px]">
          Take a look at some of our favorite projects - from sleek startups to
          enterprise solutions. Each one tells a story of collaboration,
          creativity, and craft.
        </p>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {cards.map((card) => (
          <div key={card.id} className="border rounded-3xl pb-8">
            <div className="">
              <Image
                src={card.image}
                alt="project-image"
